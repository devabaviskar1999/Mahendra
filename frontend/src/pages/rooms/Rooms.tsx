...
export default function Rooms() {
  ...
  return (
    <ScrollToTop>
        ...
        py-6 md:py-10"
        >
          <h1 className="text-3xl p-1 sm:text-4xl md:text-5xl lg:text-5xl font-semibold text-white ">
            Rooms
          </h1>
          <h2 className="font-serif text-sm text-center md:text-lg text-white">
            Experience the luxury of our{" "}
            <span className="font-semibold text-white">five</span> exclusive room
